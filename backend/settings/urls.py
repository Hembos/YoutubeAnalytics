...
urlpatterns = [
    ...
    path('api/v1/add-video-to-group/', AddVideoToGroupView.as_view(), name="email-verify"),
    path('api/v1/add-channel-to-group/', AddChannelToGroupView.as_view(), name="email-verify"),
